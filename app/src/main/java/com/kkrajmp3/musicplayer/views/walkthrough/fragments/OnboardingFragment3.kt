...
import com.kkrajmp3.musicplayer.databinding.FragmentOnboarding3Binding
...
class OnboardingFragment3 : Fragment() {
    ...
    override fun onCreateView(inflater: LayoutInflater, container: ViewGroup?, savedInstanceState: Bundle?): View? {
        ...
        binding = DataBindingUtil.inflate(layoutInflater, R.layout.fragment_onboarding3, container, false)
        return binding.root
    }
}